...
<div class="subTitle">
	<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $site_name ;?> - <?php echo $_lang['htmlsnippet_title']; ?></span>
...
<?php if($_GET['a']!='77') { ?><script>document.getElementById("Button2").setEnabled(false);</script><?php } ?>
