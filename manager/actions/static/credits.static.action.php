...
?>
<div class="subTitle">
<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $site_name ;?> - <?php echo $_lang['credits']; ?></span>
</div>
...
<table width="500"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr height="70">
    <td align="center"><a href="http://www.mantisbt.org" target="_blank"><img src="media/images/credits/mantis.gif" border="0"></a></td>
    <td align="left"><?php echo $_lang['credits_mantis']; ?></td>
  </tr>
  <tr height="70">
