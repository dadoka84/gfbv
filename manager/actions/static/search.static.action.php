...
<div class="subTitle">
	<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $site_name ;?> - <?php echo $_lang['search']; ?></span>
</div>
  ...
  <tr>
  	<td colspan="4">
		<table cellpadding="0" cellspacing="0" border="0">
		    <td id="button1" align="right" onaction="document.searchform.submitok.click();"><img src="media/images/icons/save.gif" align="absmiddle"> <?php echo $_lang['search']; ?>
				<script>createButton(document.getElementById("Button1"));</script>	
			</td>
		    <td id="button2" align="right" onaction="document.location.href='index.php?a=2';"><img src="media/images/icons/cancel.gif" align="absmiddle"> <?php echo $_lang['cancel']; ?>
