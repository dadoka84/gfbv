...
?>
<div class="subTitle">
<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $site_name ;?> - <?php echo $_lang['messages_title']; ?></span>
</div>
...
<table width="600" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			<td id="Button11" onaction="document.location.href='index.php?a=10&t=c&m=rp&id=<?php echo $message['id']; ?>';"><img src="media/images/icons/reply.gif" align="absmiddle"> <?php echo $_lang['messages_reply']; ?></td>
...
<?php if($message['sender']==0) { ?>				<script>document.getElementById("Button11").setEnabled(false);</script><?php } ?>
			<td id="Button21" onaction="document.location.href='index.php?a=10&t=c&m=f&id=<?php echo $message['id']; ?>';"><img src="media/images/icons/forward.gif" align="absmiddle"> <?php echo $_lang['messages_forward']; ?></span></td>
				<script>createButton(document.getElementById("Button21"));</script>
			<td id="Button31" onaction="document.location.href='index.php?a=65&id=<?php echo $message['id']; ?>';"><img src="media/images/icons/delete.gif" align="absmiddle"> <?php echo $_lang['delete']; ?></span></td>
...
<p>
	<table cellpadding="0" cellspacing="0">
		<tr>
			<td id="Button1" onaction="documentDirty=false; document.messagefrm.submit();"><img src="media/images/icons/save.gif" align="absmiddle"> <?php echo $_lang['messages_send']; ?></td>
				<script>createButton(document.getElementById("Button1"));</script>
			<td id="Button2" onaction="document.location.href='index.php?a=10&t=c';"><img src="media/images/icons/cancel.gif" align="absmiddle"> <?php echo $_lang['cancel']; ?></span></td>
