...
<div class="subTitle">
<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $site_name ;?> - View manager logs</span>
</div>
...
?> 
  ...
  <tr bgcolor='#FFFFFF'> 
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			<td id="Button1" onaction="document.logging.log_submit.click();"><img src="media/images/icons/save.gif" align="absmiddle"> <?php echo $_lang['search']; ?></td>
				<script>createButton(document.getElementById("Button1"));</script>
			<td id="Button2" onaction="document.location.href='index.php?a=13';"><img src="media/images/icons/cancel.gif" align="absmiddle"> <?php echo $_lang['cancel']; ?></span></td>
