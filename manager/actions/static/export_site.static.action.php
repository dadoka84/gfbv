...
<div class="subTitle">
<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $site_name ;?> - <?php echo $_lang['export_site']; ?></span>
</div>
...
<table cellpadding="0" cellspacing="0">
	<td id="Button1" onaction="document.exportFrm.submit();"><img src="media/images/icons/save.gif" align="absmiddle"> <?php echo $_lang["export_site_start"]; ?></td>
