...
<html>
	...
	function hideTreeFrame() {
		...
		try {
			top.topFrame.document.getElementById('tocText').innerHTML="<a href='javascript:parent.scripter.defaultTreeFrame();'><img src='media/images/icons/inet1-15.gif' border=0 align='absmiddle' alt='<?php echo $_lang['show_tree']; ?>'></a>";
