<?php if(IN_ETOMITE_SYSTEM!="true") die("<b>INCLUDE_ORDERING_ERROR</b><br /><br />Please use the Etomite Manager instead of accessing this file directly."); ?>
<html>
<head>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0"  class="menu-body">
  <tr style="height: 21px;">
    ...
    <td id="button1" align="right" width="1" onaction="top.location='index.php?a=8';"><?php echo $_lang["logout"]; ?></td>
