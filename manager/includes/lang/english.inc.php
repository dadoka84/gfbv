...
/***************************************************************************
 ...
 Function:	English language file for Site.
 Author:	Alex Butter
/***************************************************************************/

$_lang["login_message"] = "Please enter your login credentials to start your session. Your username and password are case-sensitive, so please enter them carefully!"; // changed 06 RC2
$_lang["username"] = "Username";
$_lang["password"] = "Password";
$_lang["remember_username"] = "Remember me";
$_lang["login_button"] = "Login";
$_lang["home"] = "Home";
$_lang["my_etomite"] = "My Site";
...
$_lang["edit_settings"] = "Site configuration";
...
$_lang["welcome_title"] = "Welcome to Site";
$_lang["welcome_message"] = "Welcome to Site! To start, select a document from the tree to
 the left of the screen, or choose a menu option from the main menu. Suggestions, comments or compliments are always welcome at 
 the <a href='http://www.buonarte.com/' target='_blank'>BuonArte 
 site</a>.<p>I hope you enjoy using this system,<br />Alex"; // deprecated as of 0.6!
...
$_lang["configcheck_installer_msg"] = "The install/ directory contains the installer for Site. Just imagine what might happen if an evil person finds this folder and runs the installer! He'd probably not get too far, because he'll need to enter some user information for the database, but it's still best to remove this folder from your server.";
$_lang["configcheck_cache"] = "cache directory not writable";
$_lang["configcheck_cache_msg"] = "Site cannot write to the cache directory. Site will still function as expected, but no caching will take place. To solve this, make the /_cache/ directory writable.";
...
$_lang["to"] = "to";
$_lang["total"] = "total";
$_lang["settings_title"] = "Site configuration";
...
$_lang["friendlyurls_message"] = "This allows you to use search engine friendly URLs with Site. Please note, this only works for Site installations running on Apache, and you'll need to write a .htaccess file for this to work. See the .htaccess file included in the distribution for more info.";
...
$_lang["language_message"] = "Select the language for the Site Manager.";
...
$_lang["enabledebug_message"] = "Selecting 'Yes' will show some debug information about the different functions in Site. Generally, you won't need to use this, however, if you're trying to solve a bug, it may be handy to turn this on.";
...
$_lang['actioncomplete'] = "<b>Action was completed successfully!</b><br /> - Please wait while Site cleans up.";
...
$_lang['weblink_message'] = "A weblink is a reference to an object on the internet. This could be a document within Site, a page on another site or an image or other file on the internet.<p>";
...
$_lang['document_opt_folder_help'] = "Check this to make the document also act as a folder for other documents. You don't need to worry about this too much, as Site generally takes care of folder settings automatically.";
...
$_lang['document_opt_emptycache_help'] = "Leaving this field checked will make Site empty the cache after you save the document. This way your visitors will not see an older version of the document.";
...
$_lang['personal_prefs_message'] = "Currently there are no preferences which can be changes on a per-user basis. This section will contain options for overriding stuff like language settings, eventually. Please edit the Site configuration to change settings.";
...
$_lang['password_gen_gen'] = "Let Site generate a password.";
...
$_lang['about_title'] = "About Site";
$_lang['about_msg'] = "Site was written by Alex, and is licensed under <a href=\"../assets/docs/license.txt\">GPL</a>."; //changed 06 RC2
...
$_lang['credits_adodb'] = "John Lim built this great database abstraction layer. Site uses only the MySQL bits, but it's lovely nonetheless!"; // obsolete
$_lang['credits_php'] = "Site is powered by PHP!"; // obsolete
$_lang['credits_mysql'] = "Site is powered by MySQL!"; // obsolete
$_lang['credits_vorx'] = "Vorx kindly hosts the Site.org domain, home of Site!"; // obsolete
$_lang['credits_phpBB'] = "The Site forums are powered by phpBB!"; // obsolete
$_lang['credits_mantis'] = "The Site bugtracker is powered by Mantis!"; // obsolete
$_lang['credits_webfx'] = "Site uses a number of JavaScripts from Webfx. Great stuff!"; // obsolete
$_lang['credits_dTree'] = "Site uses the excellent dTree script from DestroyDrop.com!"; // obsolete
$_lang['credits_jpgraph'] = "Site uses JpGraph to generate visitor statistics!"; // obsolete
...
<li>Everyone who has provided feedback on Site, or suggested new features, or who have donated money to thank me for my hard work. Thanks guys!</li></ul>"; // changed (this changes almost every release)  // obsolete
...
$_lang['help_msg'] = "If you need help using Site, your best bet is to visit the <a href='http://forums.Site.org' target='_blank'>Site Forums</a>. Also, the <a href='http://wiki.Site.org' target='_blank'>Site site</a> contains some documentation about using Site or how to set it up, the answer you're looking for might be there. If not, post your question in the forums, and I'll answer as soon as I can.";
...
$_lang['php_version_check'] = "Site is compatible with PHP version 4.0.3 and higher. Please upgrade your PHP installation!";
...
$_lang['signupemail_message'] = "Here you can set the message sent to your users when you create an account for them and let Site send them an e-mail containing their username and password. <b>Note:</b> The %s codes are replaced by Site when it sends the message. The first %s is always replaced with the username, and the second with the password. <b>Leave the two %s codes in the e-mail, or else the username and password won't be sent in the mail and your users won't know their username or password!</b>";
...
$_lang['im_plugin_base_dir_message'] = "[HTMLArea only] - This setting is usually automatically generated. If you're using IIS, however, Site may not be able to work the path out on it's own, causing the ImageManager to show an error. In that case, you can enter the path to the images directory here (the path as you'd see it in Windows Explorer)."; // changed 0.6 RC2
$_lang['im_plugin_base_url_title'] = "URL to images directory:";
$_lang['im_plugin_base_url_message'] = "[HTMLArea only] - This setting is usually automatically generated. If you're using IIS, however, Site may not be able to work the URL out on it's own, causing the ImageManager to show an error. In that case, you can enter the URL to the images directory here (the URL as you'd enter it on Internet Explorer)."; // changed 0.6 RC2
$_lang['stay'] = "Continue editing after saving";
$_lang['saving'] = "Saving, please wait...";
$_lang['charset_title'] = "Character encoding:";
$_lang['charset_message'] = "Please select which character encoding you wish to use in the manager. Please note that Site has been tested with a number of these encodings, but not all of them. For most languages, the default setting of ISO-8859-1 suffices.";
...
$_lang['layout_message'] = "Use this option to select the layout for the Site manager.";
...
$_lang['loading_page'] = "Please wait while Site loads the page...";
...
$_lang['filemanager_path_message'] = "IIS often does not populate the document_root setting properly, which is used by the file manager to determine what you can look at. If you're having problems using the file manager, make sure this path points to the root of your Site installation.";
...
$_lang['resolve_hostnames_message'] = "Do you want Site to try to resolve your visitors' hostnames when they visit your site? Resolving hostnames may create some extra server load, although your visitors won't notice this in any way.";
...
$_lang['no_logging_found'] = "Site did not find any logging data in the database. This means that logging is turned off, or your site has had no visitors yet.";
...
$_lang["settings_strip_image_paths_message"] = "Turning this on will have Site rewrite image src's to be relative instead of absolute. This is very handy if you should ever wish to move your Site installation (for example from a staging site to a production site). If you have no idea what this means, it's best just to leave it set to 'No'.";
...
$_lang['export_site_maxtime_message'] = "Here you can specify the number of seconds Site can take to export the site (overriding PHP settings). Enter 0 for unlimited time. Please note, setting 0 or a really high number can do weird things to your server and is not recommended.";
