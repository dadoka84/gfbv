  ...
  <tr>
	...
	<!-- intro text, logo and login box -->
		...
		<table border="0" width="600" cellspacing="0" cellpadding="10" class="loginTbl">
		  <tr>
			<td>
				<b>Etomite is © and ™ of the Etomite project</b>, and is licensed under the GPL license. Failure to adhere to this license 
				- or the removal of this notice without the express written permission of the Etomite project - is a breach of the terms and 
				conditions you agreed to when you installed this software.<br /><br />
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
