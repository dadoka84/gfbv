...
/*******************************************************************************/
		...
		?>
<div class="subTitle">
<span class="right"><img src="media/images/_tx_.gif" width="1" height="5"><br /><?php echo $site_name ;?> - <?php echo $_lang['cleaningup']; ?></span>
</div>

<div id="disp">
<?php echo $_lang['actioncomplete']; ?><p>&nbsp;
<?php echo printf($_lang["password_msg"], $newusername, $newpassword); ?>
<script language="JavaScript">
doRefresh(2);
</script>
</div>
