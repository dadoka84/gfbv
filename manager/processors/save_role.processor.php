...
switch ($_POST['mode']) {
    case '38':
		...
		edit_role, save_role, delete_role, new_role, access_permissions)
    ...
    case '35':
		...
		edit_role=$edit_role, save_role=$save_role, delete_role=$delete_role, new_role=$new_role, access_permissions=$access_permissions WHERE id=$id";
