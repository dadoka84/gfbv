  ...
  <tr>
    <td><table width="200" border="0" cellpadding="0" cellspacing="0">
      ...
      <map name="Map2">
        ...
        <area shape="rect" coords="40,39,53,50" href="index.php/sitemap-deu.html">
      </map>
    </td>
  </tr>
  <tr>
	...
	<object classid="clsid:D27CDB6E-AE6D-11CF-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" border="0" width="777" height="154">
		<param name="movie" value="images/gfbvdeu.swf">
		<param name="quality" value="High">
	  <embed src="images/gfbvdeu.swf" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="777" height="154"></object>
	</td>
  </tr>
  <tr>
    <td><table width="200" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td align="left" valign="top" bgcolor="#FFFFFF"><table width="10" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="images/imgd_10.jpg" width="184" height="80" border="0" usemap="#Map" /></td>
          </tr>
          <tr>
            <td class="razmak"></td>
          </tr>
          <tr>
            <td class="trazilicad"><span class="stubmapa"><img src="images/blank.gif" alt="s" width="10" height="12" /><br>
          ...
          <tr>
            <td><img src="images/imgd_17.jpg" width="184" height="15" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><img src="images/imgd_23.jpg" width="184" height="15" /></td>
          </tr>
          <tr>
