 ...
 *   dbPconnect = set to true if you want to use persistant connections
 * 
 ...
 *
 * Stop words are words that are not indexed for searching. Dynamic stop words 
 * are keywords that occur very often and therefore are ignored. You can set 
 * the threshold for dynamic stopwords here.
 * 
 * Words with less characters than the minWordLenght will not be indexed for 
 * searching. A smaller number will increase the size of your database.
 * 
...
$GLOBALS['TL_CONFIG']['dynamicStopword']   = 24;
$GLOBALS['TL_CONFIG']['minWordLength']     = 3;
...
$GLOBALS['TL_CONFIG']['extractTplVars']    = false;
