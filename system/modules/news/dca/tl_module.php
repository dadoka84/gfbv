 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['newslist']    = 'name,type,headline;news_archives,news_template;news_metaFields,news_dateFormat;news_numberOfItems,perPage,skipFirst,searchable;guests,protected;align,space,cssID';
...
$GLOBALS['TL_DCA']['tl_module']['palettes']['newsarchive'] = 'name,type;news_archives,news_template;news_metaFields,news_dateFormat;perPage,news_jumpToCurrent,searchable;guests,protected;align,space,cssID';
