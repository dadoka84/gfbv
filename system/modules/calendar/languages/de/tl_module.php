...
$GLOBALS['TL_LANG']['tl_module']['cal_template'] = array('Eventvorlage', 'Bitte wählen Sie ein Eventlayout. Sie können eigene Eventlayouts im Ordner <em>templates</em> speichern. Vorlagen müssen mit <em>event_</em> beginnen und die Dateiendung <em>.tpl</em> haben.');
