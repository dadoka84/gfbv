...
$GLOBALS['TL_DCA']['tl_module']['palettes']['minicalendar']    = 'name,type,headline;cal_calendar,cal_startDay;cal_noSpan,cal_previous,cal_next;jumpTo;guests,protected;align,space,cssID';
...
$GLOBALS['TL_DCA']['tl_module']['palettes']['eventlist']       = 'name,type,headline;cal_calendar,cal_format,cal_startDay;cal_noSpan,cal_template;searchable;guests,protected;align,space,cssID';
