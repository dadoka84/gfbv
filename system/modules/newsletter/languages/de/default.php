 ...
 * Error messages
 */
$GLOBALS['TL_LANG']['ERR']['subscribed']   = 'Sie haben diesen Verteiler bereits abonniert.';
$GLOBALS['TL_LANG']['ERR']['unsubscribed'] = 'Sie haben diesen Verteiler nicht abonniert.';
