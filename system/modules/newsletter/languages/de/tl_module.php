 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_module']['nl_channel']     = array('Verteiler', 'Bitte wählen Sie einen Verteiler.');
...
$GLOBALS['TL_LANG']['tl_module']['nl_subscribe']   = array('Bestell-Bestätigung', 'Bitte geben Sie den Text der Bestätigungsmail ein. Sie können die Platzhalter <em>##channel##</em> (Name des Newsletters), <em>##domain##</em> (aktuelle Domain) und <em>##link##</em> (Aktivierungslink) verwenden.');
$GLOBALS['TL_LANG']['tl_module']['nl_unsubscribe'] = array('Abbestell-Bestätigung', 'Bitte geben Sie den Text der Bestätigungsmail ein. Sie können die Platzhalter <em>##channel##</em> (Name des Newsletters) und <em>##domain##</em> (aktuelle Domain) verwenden.');
