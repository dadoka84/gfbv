 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['subscribe']   = 'name,type,headline;nl_channel,nl_template;nl_subscribe;jumpTo;guests,protected;align,space,cssID';
$GLOBALS['TL_DCA']['tl_module']['palettes']['unsubscribe'] = 'name,type,headline;nl_channel,nl_template;nl_unsubscribe;jumpTo;guests,protected;align,space,cssID';
