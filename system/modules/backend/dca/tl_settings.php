...
(
	...
	(
		...
		'default'                     => 'websiteTitle,adminEmail;dateFormat,timeFormat,datimFormat,timeZone;websitePath,characterSet,urlSuffix,encryptionKey,customSections,maxImageWidth,resultsPerPage;rewriteURL,disableAlias,extractTplVars,displayErrors,debugMode,disableRefererCheck,useDompdf,enableGZip;editableFiles,validImageTypes,allowedDownload,uploadTypes,allowedTags;useSMTP;useFTP;uploadPath,maxFileSize,imageWidth,imageHeight,jpgQuality,uploadFields;backendTheme,inactiveModules,doNotCollapse;undoPeriod,versionPeriod,logPeriod,sessionTimeout,lockPeriod;dynamicStopword,minWordLength;defaultUser,defaultGroup,defaultChmod'
	),
